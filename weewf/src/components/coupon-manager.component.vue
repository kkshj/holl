<template>
  <div>
    <el-row class="header">
      ...
      <el-col :span="6">
        <el-button type="primary" plain icon="el-icon-plus" @click="goToDetail('add', '')">添加优惠券</el-button>
      </el-col>
    </el-row>
<!--    <el-row class="search">
      <el-col :span="7">
    ...
    <el-table :data="couponlist"  v-loading="loading" style="width: 100%">
      ...
      <el-table-column align="left" label="操作" width="340">
        <template slot-scope="scope">
          <el-button type="warning" plain icon="el-icon-download" @click="downloadCouponCode(scope.row.code)">下载二维码</el-button>
          <el-button size="mini" type="success" plain @click="goToDetail('check', scope.row.code)">查看</el-button>
          <el-button size="mini" type="primary" plain @click="goToDetail('update', scope.row.code, scope.row.id)">修改</el-button>

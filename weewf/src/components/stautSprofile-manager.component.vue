<template>
  <div>
    <el-row class="header">
      <el-col :span="18"><h4>状态信息</h4></el-col>
      <el-col :span="6"><el-button type="primary" plain icon="el-icon-plus" @click="goToDetail('add', '')">添加状态信息</el-button></el-col>
    </el-row>
    ...
    <el-table :data="stautSprofileList" style="width: 100%">
      <el-table-column align="left" type="index"></el-table-column>
      <el-table-column align="left" label="状态1" prop="staId"></el-table-column>
      <el-table-column align="left" label="状态2" prop="staId2"></el-table-column>
      <el-table-column align="left" label="机构类型" prop="positionalTitleName"></el-table-column>
  ...
  import conf from '../config.json'
    ...
    export default {
        ...
        methods: {
          ...
          goToDetail (type, id) {
            this.$router.push({
              path: '/stautSprofile-manager/detail',
              query: {
                type: type,
                id: id
              }
